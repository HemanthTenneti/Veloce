...
export default function HeroSection() {
  ...
  // Pause Spline render loop when hero is off-screen, resume before it re-enters
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {/* Spline Component - Behind Text Layer, hover-interactable */}
      <div
        className="hidden lg:block absolute inset-0 z-[11] w-full h-full"
      >
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 pointer-events-none">
        <div className="flex-1 min-w-0 hero-content pt-28 md:pt-32 max-w-[42rem]">
          ...
          <h2
            ...
            style={{ color: "var(--text-primary)" }}
          >
            Harmonized for desire.
          </h2>
          <p
            className="font-normal text-base md:text-[1.05rem] max-w-xl mb-10 leading-7 gs-reveal"
            style={{ color: "var(--text-secondary)" }}
          >
            A boutique showroom for performance and luxury vehicles, edited with the discipline of an atelier. Every listing is inspected, photographed, and presented with calm precision.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 gs-reveal pointer-events-auto">
            ...
            <Link href="/inventory" className="luxury-button luxury-button--ghost">
               Contact Us
              <FiPhoneCall size={16} />
            </Link>
          </div>
